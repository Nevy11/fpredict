  ...
  return (
    <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
      ...
      <nav className="sidebar-nav">
        ...
        <Link to="/fixtures" className="nav-item" activeProps={{ className: 'active' }}>
          <div className="nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <span className="nav-label">All Fixtures</span>
        </Link>

        <Link to="/players" className="nav-item" activeProps={{ className: 'active' }}>
          <div className="nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <span className="nav-label">Player Intelligence</span>
        </Link>

        <Link to="/fantasy" className="nav-item" activeProps={{ className: 'active' }}>
          <div className="nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <span className="nav-label">Fantasy Engine</span>
        </Link>

        <Link to="/managers" className="nav-item" activeProps={{ className: 'active' }} preload={false}>
          <div className="nav-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <Link to="/settings" className="nav-item" activeProps={{ className: 'active' }}>
          ...
          <span className="nav-label">Settings & Risk</span>
        </Link>
      </nav>
    </aside>
  );
