...
function Fixtures() {
  ...
  if (currentFixtures.length > 0) {
    const firstFixtureDate = new Date(currentFixtures[0].date);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "container page-stack relative pb-20", children: [
    /* @__PURE__ */ jsx("div", { className: "absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-cyan-500/10 blur-[120px] rounded-full pointer-events-none -z-10" }),
    /* @__PURE__ */ jsxs("header", { className: "page-header flex flex-col items-center text-center mt-8 mb-16", children: [
      /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-cyan-400 text-sm font-semibold tracking-widest uppercase mb-6 backdrop-blur-md shadow-[0_0_15px_rgba(0,240,255,0.1)]", children: [
        /* @__PURE__ */ jsx(CalendarDays, { size: 16 }),
        /* @__PURE__ */ jsx("span", { children: "Season Schedule" })
      ] }),
      /* @__PURE__ */ jsx("h1", { className: "heading-primary text-5xl md:text-6xl mb-4", children: "All Fixtures" }),
      /* @__PURE__ */ jsx("p", { className: "subtitle text-lg md:text-xl max-w-2xl text-gray-400 mx-auto", children: "Select any fixture across the season to initialize the predictive engine and uncover algorithmic value bets." })
    ] }),
    monthYears.length > 0 && /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto w-full flex flex-col gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between glass-card p-4 md:px-8 border border-white/10", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsx("h2", { className: "text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400", children: currentMonthYear }),
        /* @__PURE__ */ jsx(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "glass-card p-4 md:p-8 border border-white/10 hover:border-cyan-500/30 transition-all duration-500", children: [
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-7 gap-2 md:gap-4 mb-4", children: daysOfWeek.map((day) => /* @__PURE__ */ jsx("div", { className: "text-center text-xs md:text-sm font-semibold text-gray-400 uppercase tracking-wider py-2", children: day }, day)) }),
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-7 gap-2 md:gap-4", children: days.map((day, idx) => {
          if (day === null) {
            return /* @__PURE__ */ jsx("div", { className: "h-28 md:h-36 bg-black/20 rounded-xl border border-white/5 hidden md:block" }, `empty-${idx}`);
          }
          const dayFixtures = currentFixtures.filter((f) => new Date(f.date).getDate() === day);
          const hasFixtures = dayFixtures.length > 0;
          return /* @__PURE__ */ jsxs(
            "div",
            {
              className: `h-28 md:h-36 rounded-xl border p-2 md:p-3 flex flex-col gap-2 overflow-y-auto custom-scrollbar transition-all duration-300
                      ${hasFixtures ? "bg-black/60 border-white/10 hover:border-cyan-500/50 hover:bg-black/80 hover:shadow-[0_0_15px_rgba(0,240,255,0.05)]" : "bg-black/20 border-white/5 opacity-60"}`,
              children: [
                /* @__PURE__ */ jsx("span", { className: `text-xs md:text-sm font-bold ${hasFixtures ? "text-cyan-400" : "text-gray-500"}`, children: day }),
                /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1.5", children: dayFixtures.map((match) => /* @__PURE__ */ jsxs(
                  Link,
                  {
                    to: "/",
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-1 w-full", children: [
                        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 truncate", children: [
                          /* @__PURE__ */ jsx("div", { className: `shrink-0 w-1.5 h-1.5 rounded-full bg-gradient-to-br ${getTeamGradient(match.home)}` }),
                          /* @__PURE__ */ jsx("span", { className: "text-[10px] md:text-xs text-gray-300 group-hover:text-white truncate font-medium", children: getTeamInitial(match.home) })
                        ] }),
                        /* @__PURE__ */ jsx("span", { className: "text-[8px] text-gray-500 font-bold shrink-0", children: "VS" }),
                        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 truncate flex-row-reverse", children: [
                          /* @__PURE__ */ jsx("div", { className: `shrink-0 w-1.5 h-1.5 rounded-full bg-gradient-to-br ${getTeamGradient(match.away)}` }),
                          /* @__PURE__ */ jsx("span", { className: "text-[10px] md:text-xs text-gray-300 group-hover:text-white truncate font-medium", children: getTeamInitial(match.away) })
                        ] })
                      ] }),
                      /* @__PURE__ */ jsx("div", { className: "text-[10px] text-cyan-400 font-medium opacity-0 group-hover:opacity-100 transition-opacity absolute inset-0 bg-black/80 flex items-center justify-center rounded-lg backdrop-blur-sm shadow-[0_0_10px_rgba(0,240,255,0.2)]", children: match.time })
                    ]
                  },
